# CircuitRelay Website - Admin Text Editing & GitHub Push

## Task
Make most page text editable from the Admin Panel, then push changes to GitHub.

## Steps
- [x] Add IDs to hero, mission, impact, programs, contact sections
- [x] Add IDs to navigation links
